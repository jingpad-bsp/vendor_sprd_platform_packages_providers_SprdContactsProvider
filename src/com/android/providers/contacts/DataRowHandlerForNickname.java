...
public class DataRowHandlerForNickname extends DataRowHandlerForCommonDataKind {
    ...
    public long insert(SQLiteDatabase db, TransactionContext txContext, long rawContactId,
        ...
        if (!TextUtils.isEmpty(nickname)) {
            ...
            updateData(rawContactId,values);
        }
        return dataId;
    }
    ...
    public int delete(SQLiteDatabase db, TransactionContext txContext, Cursor c) {
        ...
        values.put(Nickname.NAME, (String) null);
        updateData(rawContactId,values);
        /*
         * @}
         */
     ...
     * @{
     */
    private void updateData(long rawContactId, ContentValues values) {
        ...
        if (simProxyUtil.isMyContact(rawContactId)) {
            contactProxyManager.onDataUpdate(rawContactId, values, Nickname.CONTENT_ITEM_TYPE);
        }
    }
    /*
     * @}
