    ...
    private final class OpenHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE TABLE " + Tables.CALLS + " (" +
                    ...
                    Calls.USERS_ID + " INTEGER NOT NULL DEFAULT 0," +
                    /** SPRD: DIALPAD SEARCH Feature @{ */
                    CACHED_NORMALIZED_SIMPLE_NAME  + " TEXT," +
                    CACHED_NORMALIZED_FULL_NAME  + " TEXT," +
                    /* @} */
    ...
    private void upgradetoVersion8(SQLiteDatabase db) {
        ...
        try {
            ...
            String allTheColumns = Calls._ID + ", " +
                    ...
                    Calls.BLOCK_REASON + ", " +
                    /* UNISOC: modify for bug1236202 @{ */
                    /* SPRD: add for distinguish guest and owner in callLog @{ */
                    Calls.USERS_ID + ", " +
                    /** SPRD: DIALPAD SEARCH Feature @{ */
                    CACHED_NORMALIZED_SIMPLE_NAME  + ", " +
                    CACHED_NORMALIZED_FULL_NAME  + ", " +
                    /* @} */
                    /* @} */
                    Voicemails._DATA + ", " +
