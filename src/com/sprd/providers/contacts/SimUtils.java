...
public class SimUtils {
    ...
    public static int getSimCardLength(int subId) {
        ...
        Log.d(LOG_TAG, "getSimCardLength ret: " + ret);
        return ret;
    }
        ...
        try {
            ...
            if (iccIpb != null) {
                ...
                if (sizes != null && sizes.length > 0) {
                    ...
                    Log.d(LOG_TAG, "sizes is null or size is 0");
                    return 12;
                }
                Log.d(LOG_TAG, "getSimContactNameLength ret: " + ret);
                ret = size;
            } else {
                return 12;
            }
    ...
    public static int getSimSneLength(int subId) {
        ...
        try {
            ...
            if (iccIpb != null) {
                ...
                //SPRD: add for bug820785, ArrayIndexOutOfBoundsException for sizes
                if (sizes == null || sizes.length == 0) {
                    Log.d(LOG_TAG, "sizes is null or size is 0");
                    return 12;
                }
     ...
     * @{
     */
    public  static int getSimSneSize(int subId) {
        int ret=-1;
        try {
            IIccPhoneBookEx iccIpb = getIccPhoneBook();
            if (iccIpb != null) {
                ret = iccIpb.getSneSize(subId);
            } else {
                return -1;
            }
        } catch (RemoteException ex) {
    ...
    public static int getSimContactEmailLength(int subId) {
        ...
        Log.d(LOG_TAG, "getSimContactEmailLength ret: " + ret);
        return ret;
    }
    ...
    public static int getSimContactEmailCapacity(int subId) {
        ...
        Log.d(LOG_TAG, "getSimContactEmailCapacity ret: " + ret);
        return ret;
    }
    ...
    public static int getSimContactPhoneTypeOverallMax(int subId) {
        ...
        ret++;
        Log.d(LOG_TAG, "getSimContactPhoneTypeOverallMax ret: " + ret);
        return ret;
    }
     ...
     * @{
     */
    public static int[] getUsimGroupSize(int subId) {
        IIccPhoneBookEx iccIpb = getIccPhoneBook();
        int[] ret = null;
        if (iccIpb != null) {
            try {
                ret = iccIpb.getUsimGroupSize(subId);
            } catch (RemoteException e) {
                e.printStackTrace();
            }
        }
        if (DEBUG)
            Log.d(LOG_TAG, "getUsimGroupSize = " + Arrays.toString(ret));
        return ret;
    }
    /*
     * @}
    ...
    public static int getSimContactGroupTypeOverallMax(int subId) {
        IIccPhoneBookEx iccIpb = getIccPhoneBook();
        int ret = 0;
        if (iccIpb != null) {
            try {
                ret = iccIpb.getGroupNum(subId);
            } catch (RemoteException e) {
                e.printStackTrace();
            }
        }
        if (DEBUG)
            Log.d(LOG_TAG, "GroupTypeOverallMax = " + ret);
        return ret;
    }
}
/**
