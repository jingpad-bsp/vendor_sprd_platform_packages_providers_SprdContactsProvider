...
public class ContactAccountManager {
     ...
     */
    // SPRD: Bug797548 monkey test,acore crash, asynchronous operation,mInitializationLatch may is null
    private synchronized void loadAccountsInBackground() {
        if (DEBUG)
    ...
    public Account getSimAccount(int phoneId) {
        ...
        /**
         * SPRD Bug662836 ensure the account of the ContactAccountManager is same as the AccountManager
         * @{
         */
        loadAccountsInBackground();
        /**
